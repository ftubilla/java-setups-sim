...
public class OptimizationConstraint {
    ...
    /**
     * Sets the constraint equal to the given value and prevents any further
     * addition of terms.
     * 
     * @param rightHandTerm
     */
    ...
    /**
     * Sets the constraint to less-equal than the given value and prevents any
     * further addition of terms.
     * 
     * @param rightHandTerm
     */
    public void lEql(double rightHandTerm) {
        this.rightHandTerm = rightHandTerm;
        sense = Sense.LEQ;
        expression.append("<= ").append(rightHandTerm);
    }
    ...
    /**
     * Sets the constraint to greater-equal than the given value and prevents
     * any further addition of terms.
     * 
     * @param rightHandTerm
     */
