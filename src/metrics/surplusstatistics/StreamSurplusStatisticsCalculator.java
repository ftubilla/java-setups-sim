...
/**
 * Computes the surplus statistics on-line, without the need to store
 ...
 */
@Getter
public class StreamSurplusStatisticsCalculator extends AbstractSurplusStatisticsCalculator implements SurplusStatistics {
