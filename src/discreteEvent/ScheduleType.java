...
public enum ScheduleType {
    ...
    // Note: the order of declaration here is important because it determines
    // which
    // type of event(s) get processed first if two or more events occur at the
    // same time!
    // dumpable? delayable?
    DEMAND(false, false),
    ...
    private final boolean dumpable; // In a dumpable schedule, we can clear the
                                    // queue of events at any time
