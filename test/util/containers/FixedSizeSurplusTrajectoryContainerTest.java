...
public class FixedSizeSurplusTrajectoryContainerTest extends SimBasicTest {

	@Test
	public void testAddPoint() {
		int numDataPoints = 10;
		double[] surplusTargets = new double[]{0.0, 0.0, 0.0}; 
		ISurplusTrajectoryContainer container = new FixedSizeSurplusTrajectoryContainer(numDataPoints, surplusTargets);
	...
	public void testGetInterpolatedSurplus() {
		ISurplusTrajectoryContainer container = new FixedSizeSurplusTrajectoryContainer(2, new double[]{0.0, 0.0});
		double tol = 1e-6;
	...
	public void testGetSurplusDeviationArea() {
		ISurplusTrajectoryContainer container = new FixedSizeSurplusTrajectoryContainer(4, new double[]{0.0, 0.0});
		double tol = 1e-6;
		...
		container.addPoint(5, new double[]{-2.5, -2.0});
